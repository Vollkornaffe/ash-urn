...
pub fn color_description(swapchain_format: ash::vk::Format) -> ash::vk::AttachmentDescription {
...
pub fn depth_description(base: &Base) -> Result<ash::vk::AttachmentDescription, UrnError> { 
